...
$(function() {
    ...
    $(".rt-shop-option-set").each(function(){
        $(this).buttonset().find(':radio').click(function(e) {
            $(".rt-shop-product-primary-image a[class*=rt-image-ref-" + $(this).attr("title").toLowerCase().replace(/[^a-zA-Z0-9]/g, "") + "]").first().css("display","inline").siblings('a').css("display","none");
